...
class Settings:
	def __init__(self):
		...
		self.AUTH_TOKEN = "DXorjEZMwUc361JPobN0.W5x22w8S7JlbRkeDfOaEma.MSKj+emMstzCGcG1+4TVFiesov27528Wi10syx17XJk=" 
		...
		self.SITE_PATH = "./" #path/directory to save the videos, eg: /home/user/public_html/videos/.
